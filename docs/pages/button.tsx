...
const demoList = [
  ...
  <Button
    variant="solid"
    color="primary"
    leftIcon={<Icon name="gift" label="gift" className="w-4 h-4 mr-1" />}
  >
    Button
  </Button>
  <Button color="primary" rightIcon={<Icon name="gift" label="gift" className="w-4 h-4 ml-1" />}>
    Button
  </Button>
</div>`,
        readOnly: false,
...
const component = {
  name: "Button",
  importer: 'import { Button } from "@andromedaprotocol/react"',
  demoList,
  propList,
};
