import { DeepPartial } from "@andromeda-protocol/design-system/utils";
...
export interface AndromedaTheme {
...
export type AndromedaThemeOverride = DeepPartial<AndromedaTheme>;
